...
def test_list_views_ownership_type(api_client, data_fixture, alternative_per_group_license_service):
    """
    ...
    view_1 = data_fixture.create_grid_view(table=table_1, order=1, ownership_type="collaborative", created_by=user)
    view_2 = data_fixture.create_grid_view(table=table_1, order=3, ownership_type="personal", created_by=user)
    # view belongs to another user
    view_3 = data_fixture.create_grid_view(table=table_1, order=3, ownership_type="personal", created_by=user2)
