...
function populateGroup(group) {
  group._ = { loading: false, selected: false, users: [] }
  return group
}
...
export const mutations = {
  ...
  ADD_GROUP_USER(state, { groupId, id, values }) {
...
export const actions = {
   ...
   */
  forceAddGroupUser({ commit }, { groupId, id, values }) {
    commit('ADD_GROUP_USER', { groupId, id, values })
  },
  /**
